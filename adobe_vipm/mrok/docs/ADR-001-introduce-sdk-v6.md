# ADR-001: Introduce SDK v6 for SWO Extensions
...
Today SWO Extensions are built using the `mpt-extension-sdk`, which relies on a
...
SDK v6 is intended to become the **standard framework for all SWO Extensions**.
