...
def sync_agreement(
    ...
    *,
    ...
    """
    # Fetch the latest agreement details from MPT to avoid syncing outdated or changed data.
    # Other processes may update the agreement while processing, so we refresh before each sync.
