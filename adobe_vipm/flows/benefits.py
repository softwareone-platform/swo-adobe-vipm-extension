...
from adobe_vipm.adobe.constants import STATUS_3YC_DECLINED
...
from adobe_vipm.notifications import Button, send_warning
...
def check_3yc_commitment_request(mpt_client, is_recommitment=False):
    ...
    for agreement in agreements:
        ...
        if request_info["status"] == STATUS_3YC_DECLINED:
