...
class UpdatePrices(Step):
    ...
    def _get_actual_skus(self):
        ...
        order_data = self._context.adobe_new_order or self._context.adobe_preview_order
...
class ValidateSkuAvailability(Step):
    ...
    def __call__(self, mpt_client, context, next_step):
        ...
        sku_prices = get_prices_for_skus(
            context.product_id, context.currency, adobe_skus
        )  # TODO: find a different way to confirm availability
