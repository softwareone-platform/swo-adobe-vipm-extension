...
class MarketSegment(StrEnum):
    ...
    EDUCATION = "EDU"
    GOVERNMENT = "GOV"
    LARGE_GOVERNMENT_AGENCY = "GOV_LGA"


MARKET_SEGMENTS = {
    MarketSegment.COMMERCIAL: "COM",
    MarketSegment.GOVERNMENT: "GOV",
    MarketSegment.EDUCATION: "EDU",
    MarketSegment.LARGE_GOVERNMENT_AGENCY: "GOV",
}

MARKET_SEGMENT_TO_AIRTABLE_SEGMENT = {
    MarketSegment.COMMERCIAL: "Commercial",
    MarketSegment.GOVERNMENT: "Government",
    MarketSegment.EDUCATION: "Education",
    MarketSegment.LARGE_GOVERNMENT_AGENCY: "LargeGovernment",
}


FAKE_CUSTOMERS_IDS = {
    MarketSegment.COMMERCIAL: "1234567890",
    MarketSegment.GOVERNMENT: "1234567890GOV",
    MarketSegment.EDUCATION: "1234567890EDU",
    MarketSegment.LARGE_GOVERNMENT_AGENCY: "1234567890GOV",
}
