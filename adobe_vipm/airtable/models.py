...
@cache
def get_sku_adobe_mapping_model(base_info: AirTableBaseInfo):  # noqa: C901
    """
    ...
    class AdobeProductMapping(Model):
        ...
        def is_end_of_sale(self) -> bool:
            """Check if MappingEntity is end of sale."""
...
def is_sku_end_of_sale(vendor_item_id: str, _age_hash_date_do_not_remove: int) -> bool:
    ...
    Args:
        vendor_item_id: cutted Adobe SKU.
        _age_hash_date_do_not_remove: WTF

    Returns:
        bool: if sku is marked as end of sale
    """
