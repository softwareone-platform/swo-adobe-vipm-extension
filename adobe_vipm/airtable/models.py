...
from adobe_vipm.airtable.config import get_config
...
class AirTableBaseInfo:
    ...
    @classmethod
    def for_migrations(cls, product_id: str):
        """
        ...
        return AirTableBaseInfo(
            api_key=cls._config.api_key, base_id=cls._config.get_base_id(product_id)
        )

    @classmethod
    def for_pricing(cls, product_id: str):
        """
        Returns an AirTableBaseInfo object with the base identifier of the base.
        ...
        """
        return AirTableBaseInfo(
            api_key=cls._config.api_key, base_id=cls._config.get_pricing_base_id(product_id)
        )

    @classmethod
    def for_sku_mapping(cls):
        """
        Returns an AirTableBaseInfo object with the base identifier of the base.
        ...
        Returns:
            AirTableBaseInfo: The base info.
        """
        return AirTableBaseInfo(api_key=cls._config.api_key, base_id=cls._config.sku_mapping_base)
...
# # TODO: pass commitment_start_date instead of the adobe_customer
# def get_sku_price(
#     commitment_start_date: dt.date | None,
#     offer_ids: list[str],
#     product_id: str, d
#     deployment_currency: str
# ) -> dict[str, float]:
#     """
#     Get the SKU price considering the level discount and the 3YC commitment.
#
#     Args:
#         commitment_start_date: The date when the 3YC commitment started.
