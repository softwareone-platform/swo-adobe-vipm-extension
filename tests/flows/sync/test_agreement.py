...
def test_sync_agreement_prices_with_3yc(
    ...
    mock_mpt_get_agreement.return_value = agreement
    adobe_subscription = adobe_subscription_factory()
...
def test_sync_agreement_prices_large_government_agency(
    ...
    mock_mpt_get_template_by_name.assert_called_once_with(
        mock_mpt_client, "PRD-3333-3333", TEMPLATE_SUBSCRIPTION_TERMINATION
    )
    mock_get_template_data_by_adobe_subscription.assert_called_once_with(
        adobe_subscription, "PRD-3333-3333"
    )
...
def test_sync_agreement_updates_linked_membership_params(
    ...
    mock_is_sync_possible = mocker.patch.object(
        mocked_agreement_syncer, "_is_sync_possible", return_value=True
    )

    mocked_agreement_syncer.sync(sync_prices=False)  # act

    mock_is_sync_possible.assert_called_once_with()
    first_call_args = mock_mpt_update_agreement.call_args_list[0]
...
def test_get_subscriptions_for_update_with_no_lines(
    ...
    mock_mpt_get_agreement_subscription.return_value = {"id": "SUB-1000-2000-3000", "lines": []}
...
def test_sync_agreement_without_subscriptions(
    ...
    mock_mpt_get_agreement.return_value = mock_agreement
