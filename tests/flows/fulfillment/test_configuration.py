...
def test_fulfill_configuration_order(mocker):
    ...
    assert isinstance(mocked_pipeline_ctor.mock_calls[0].args[5], SubscriptionUpdateAutoRenewal)
    assert isinstance(mocked_pipeline_ctor.mock_calls[0].args[6], Step)
