...
| Airtable | Migration tracking, pricing tables, and SKU mapping | Shared service-account token (workspace-scoped Airtable PAT, provisioned and rotated by DevOps) | `EXT_AIRTABLE_API_TOKEN`, `EXT_AIRTABLE_BASES`, `EXT_AIRTABLE_PRICING_BASES`, `EXT_AIRTABLE_SKU_MAPPING_BASE` | [`adobe_vipm/airtable/models.py`](../adobe_vipm/airtable/models.py) |
